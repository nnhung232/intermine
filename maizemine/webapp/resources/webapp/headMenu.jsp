...
<div align="center" id="headercontainer">
  ...
  <div id="header">
    <a href="${WEB_PROPERTIES['project.sitePrefix']}" alt="Home" rel="NOFOLLOW"><img id="logo" src="model/images/logo.png" height="80px" alt="Logo" /></a>
  ...
  <div id="menucontainer">
    <ul id="nav">
      ...
      <li id="genomebrowser" <c:if test="${tab == 'genomebrowser'}">class="activelink"</c:if>>
              <a target="_blank" href="http://128.206.129.194/~hungnn/jbrowse/">
                <fmt:message key="menu.genomebrowser"/>
              </a>
      </li>
    </ul>
  <ul id="loginbar">
